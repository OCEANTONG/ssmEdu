...
<html lang="en">
  <head>
    ...
    <!-- easy pie chart-->
    <link href="/ssmEdu/assets/jquery-easy-pie-chart/jquery.easy-pie-chart.css" rel="stylesheet" type="text/css" media="screen"/>
    <!-- owl carousel -->
                ...
                <ul class="nav pull-right top-menu">
                    <li class="dropdown">
                        <a data-toggle="dropdown" class="dropdown-toggle" href="#">
                            ...
                            <span class="username">您好，${Users.user_id}老师</span>
                            <b class="caret"></b>
                        </a>
                  ...
                  <div class="col-lg-12">
                      <section class="panel">
                          ...
                          <div class="panel-body">
                              <div class="form">
                                  <form class="form-validate form-horizontal" id="feedback_form" method="post" action="/ssmEdu/users/update_stu_do.do">
                                      <div class="form-group ">
                                          <label for="cname" class="control-label col-lg-2">学号 <span class="required"></span></label>
                                          <div class="col-lg-10">
                                              <label for="cname" class="control-label col-lg-2"  value="${stu_u.stu_id}">${stu_u.stu_id}<span class="required"></span></label>
                                          		<input type="hidden" name="stu_id" value="${stu_u.stu_id}"/>
                                          </div>
                                      </div>
                                      <div class="form-group ">
                                          <label for="cemail" class="control-label col-lg-2">姓名 <span class="required"></span></label>
                                          <div class="col-lg-10">
                                              <input class="form-control " id="cemail" type="text" name="stu_name" value="${stu_u.stu_name}" required />
                                          </div>
                                      </div>
                                      <div class="form-group ">
                                          <label for="curl" class="control-label col-lg-2">性别</label>
                                          <div class="col-lg-10">
                                              <input class="form-control " id="curl" type="text" name="stu_sex" value="${stu_u.stu_sex}" />
                                          </div>
                                      </div>
                                      <div class="form-group ">
                                          <label for="cname" class="control-label col-lg-2">班级 <span class="required"></span></label>
                                          <div class="col-lg-10">
                                              <input class="form-control" id="subject" name="stu_class" minlength="5" type="text" value="${stu_u.stu_class}" required />
                                          </div>
                                      </div>                                      
                                      <div class="form-group ">
                                          <label for="ccomment" class="control-label col-lg-2">科目名称</label>
                                          <div class="col-lg-10">
                                              <input class="form-control " type="text" id="ccomment" name="cour_name" value="${stu_u.cour_name}" required></input>
                                              <input type="hidden" name="cour_id" value="${stu_u.cour_id}"></input>
                                          </div>
                                      </div>
									  <div class="form-group ">
                                          <label for="ccomment" class="control-label col-lg-2">成绩</label>
                                          <div class="col-lg-10">
                                              <input class="form-control " type="text" id="ccomment" name="grades" value="${stu_u.grades}"  required></input>
                                          		<input type="hidden" name="grd_id" value="${stu_u.grd_id}"></input>
                                          </div>
                                      </div>
                                      <div class="form-group">
