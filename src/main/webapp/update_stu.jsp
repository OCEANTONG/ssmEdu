                        ...
                        <div class="panel-body">
                            <div class="form">
                                <form class="form-validate form-horizontal" id="feedback_form" method="post"
                                      action="/ssmEdu/users/update_stu_do.do">
                                    <div class="form-group ">
                                        <label for="cname" class="control-label col-lg-2">学号 <span
                                                class="required"></span></label>
                                        <div class="col-lg-10">
                                            <label for="cname" class="control-label col-lg-2"
                                                   value="${stu_u.stu_id}">${stu_u.stu_id}<span class="required"></span></label>
                                            <input type="hidden" name="stu_id" value="${stu_u.stu_id}"/>
                                        </div>
                                    </div>
                                    <div class="form-group ">
                                        <label for="cemail" class="control-label col-lg-2">姓名 <span
                                                class="required"></span></label>
                                        <div class="col-lg-10">
                                            <input class="form-control " id="cemail" type="text" name="stu_name"
                                                   value="${stu_u.stu_name}" required/>
                                        </div>
                                    </div>
                                    <div class="form-group ">
                                        <label for="curl" class="control-label col-lg-2">性别</label>
                                        <div class="col-lg-10">
                                            <input class="form-control " id="curl" type="text" name="stu_sex"
                                                   value="${stu_u.stu_sex}"/>
                                        </div>
                                    </div>
                                    <div class="form-group ">
                                        <label for="cname" class="control-label col-lg-2">班级 <span
                                                class="required"></span></label>
                                        <div class="col-lg-10">
                                            <input class="form-control" id="subject" name="stu_class" minlength="5"
                                                   type="text" value="${stu_u.stu_class}" required/>
                                        </div>
                                    </div>
                                    <div class="form-group ">
                                        <label for="ccomment" class="control-label col-lg-2">科目名称</label>
                                        <div class="col-lg-10">
                                            <input class="form-control " type="text" id="ccomment" name="cour_name"
                                                   value="${stu_u.cour_name}" required></input>
                                    ...
                                    <div class="form-group ">
                                        ...
                                        <div class="col-lg-10">
                                            <input class="form-control " type="text" id="ccomment" name="grades"
                                                   value="${stu_u.grades}" required></input>
