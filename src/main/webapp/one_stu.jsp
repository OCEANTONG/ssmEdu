                  ...
                  <div class="col-lg-12">
                      <section class="panel">
                          <header class="panel-heading">
                              提示：&nbsp;&nbsp;<a class="btn btn-success" href="#"></a>&nbsp;&nbsp;为修改&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a class="btn btn-danger" href="#"></a>&nbsp;&nbsp;为删除
                          </header>
                          ...
                          <table class="table table-striped table-advance table-hover">
                           <tbody>
                              ...
                              <c:forEach items="${one_stuList}" var="l">
	                              <tr>
	                                 <td>${l.stu_id}</td>
	                                 <td>${l.stu_name}</td>
	                                 <td>${l.stu_sex}</td>
	                                 ...
	                                 <td>
	                                  <div class="btn-group">
	                                      ...
	                                      <a class="btn btn-success" href="/ssmEdu/users/sel_one.do?stu_id=${l.stu_id}&cour_name=${l.cour_name}"><i class="icon_check_alt2"></i></a>
	                                      <a class="btn btn-danger" href="/ssmEdu/users/delete_grade.do?grd_id=${l.grd_id}"><i class="icon_close_alt2"></i></a>
	                                  </div>
	                                  </td>
	                              </tr>
                             </c:forEach>                          
