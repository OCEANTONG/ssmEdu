                        ...
                        <div class="panel-body">
                            <div class="form">
                                <form class="form-validate form-horizontal" id="feedback_form" method="post"
                                      action="/ssmEdu/student/update_profile.do">

                                    <div class="form-group ">
                                        <label for="stu_id" class="control-label col-lg-2">学号 <span
                                                class="required">*</span></label>
                                        <div class="col-lg-10">
                                            <input class="form-control " id="stu_id" type="text" name="stu_id"
                                                   disabled value="${Student.stu_id}"/>
                                        </div>
                                    </div>

                                    <div class="form-group ">
                                        <label for="stu_name" class="control-label col-lg-2">姓名 <span
                                                class="required">*</span></label>
                                        <div class="col-lg-10">
                                            <input class="form-control " id="stu_name" type="text" name="stu_name"
                                                   disabled value="${Student.stu_name}"/>
                                        </div>
                                    </div>

                                    <div class="form-group ">
                                        <label for="stu_class" class="control-label col-lg-2">班级 <span
                                                class="required">*</span></label>
                                        <div class="col-lg-10">
                                            <input class="form-control " id="stu_class" type="text" name="stu_class"
                                                   disabled value="${Student.stu_class}"/>
                                        </div>
                                    </div>
